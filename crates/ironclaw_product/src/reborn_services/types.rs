...
// The operator control plane's port vocabulary is declared at the product
// boundary (`ironclaw_product_contracts::operator_service`); product's own
// operator command-plane envelope embeds it (PROPOSAL §6.1.3, §6.9.2).
use ironclaw_product_contracts::operator_service::{
    RebornLogLevel, RebornLogQueryResponse, RebornOperatorStatusResponse,

...
pub use journal::{
    ...
    OpenProcessDependencyRequest, ProcessCheckpointId, ProcessCheckpointKind,
    ...
    ProcessDependencyPort, ProcessDependencyQuery, ProcessDependencyRecord,
    ProcessDependencySettlement, ProcessDependencyState, ProcessDependencySubmission,
    ProcessFailureRecovery, ProcessGateQuery, ProcessGateQuerySource, ProcessGateRecord,
    ProcessGateScopeMatch, ProcessInputPayload, ProcessInputPort, ProcessInputRecord,

...
const SAME_LAYER_EDGE_INVENTORY: &[SameLayerEdge] = &[
    ...
    SameLayerEdge {
        crate_name: "ironclaw_webui",
        dependency_name: "ironclaw_reborn_openai_compat",
        layer: "products",
        owner: "product/",
        decided_in: "WS5",
    },
    ...
    SameLayerEdge {
        crate_name: "ironclaw_reborn_traces",
...
///
/// `ironclaw_reborn_integration_tests` predates the layer metadata (its
...
const CRATE_LAYER_ORIGINS: &[(&str, &str)] = &[
    ...
    ("ironclaw_reborn_composition", "app"),
    ("ironclaw_reborn_config", "substrates"),
    ("ironclaw_reborn_event_store", "substrates"),
...
///
/// A layer ceiling would not do. `ironclaw_extensions` moved down precisely so

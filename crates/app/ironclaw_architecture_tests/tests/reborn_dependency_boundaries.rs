...
fn reborn_contracts_crates_carry_a_checked_size_ceiling() {
    ...
    const SIZE_CEILINGS: &[(&str, usize)] = &[
        ...
        // 13_306 -> 13_327 (deferred tool promotion cache stability): the
        // `DeferredProviderToolSurface` DTO and the optional
        // `LoopCapabilityPort::deferred_tool_surface` boundary method make an
        // eager/deferred catalog explicit. Promotion policy and provider wire
        // handling remain in ironclaw_loop_host and ironclaw_llm. Count read
        // from this test's failure message.
        ("ironclaw_loop_contracts", 13_327),

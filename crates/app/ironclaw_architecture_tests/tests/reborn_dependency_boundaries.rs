...
fn reborn_contracts_crates_carry_a_checked_size_ceiling() {
    ...
    const SIZE_CEILINGS: &[(&str, usize)] = &[
        ...
        // count read from this test's own failure message.
        // 19_430 -> 19_508 (2026-08-12, #7477 channel-model fold + #7491's
        // channel-related composition test-support): the merged tree re-pins
        // at its own measured count after the second main merge. Count read
        // from this test's own failure message.
        ("ironclaw_host_api", 19_508),

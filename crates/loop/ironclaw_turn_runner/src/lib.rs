...
//! `ironclaw_architecture_tests` enforce that nothing else takes a normal cargo
...
//! (`ironclaw_turn_runner::driver_registry::DriverRegistry`,
//! `ironclaw_turn_runner::planned_driver_factory::register_default_planned_driver`, …) so that a

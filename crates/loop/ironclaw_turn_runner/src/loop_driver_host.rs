...
use ironclaw_loop_host::{
    ...
    RunCancellationObservationKind, RunStateLoopCancellationPort, StructuredOutputLoopPromptPort,
...
impl EventTriggeredHookSubscription {
    ...
    /// caller, and widening its visibility would let other `ironclaw_turn_runner`
    ...
    async fn run(
        ...
        loop {
                ...
                .await
            {
                ...
                Err(ironclaw_event_log::EventError::ReplayGap {
                    requested,
                    earliest,
                }) => {
                    tracing::error!(
...
mod event_subscription_scope_tests {
    ...
    impl DurableEventLog for HeadCursorFailingLog {
        async fn append(
            &self,
            _event: RuntimeEvent,
        ) -> Result<ironclaw_event_log::EventLogEntry<RuntimeEvent>, ironclaw_event_log::EventError>
        {
        ...
        async fn read_after_cursor(
            ...
            _limit: usize,
        ) -> Result<ironclaw_event_log::EventReplay<RuntimeEvent>, ironclaw_event_log::EventError>
        {
        ...
        async fn head_cursor(
            ...
            _stream: &EventStreamKey,
            _after: EventCursor,
        ) -> Result<EventCursor, ironclaw_event_log::EventError> {
            Err(ironclaw_event_log::EventError::DurableLog {

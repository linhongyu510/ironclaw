...
use crate::tool_disclosure::{
    ActiveSet, CAPABILITY_INFO_NAME, CapabilityCatalog, CatalogSearchResult, DisclosureCaps,
    PromotedSet, TOOL_CALL_NAME, TOOL_DESCRIBE_NAME, TOOL_SEARCH_NAME, bridge_tool_definitions,
...
impl LoopCapabilityPort for ToolDisclosureCapabilityPort {
    ...
    fn deferred_tool_definitions(&self) -> Result<Vec<ProviderToolDefinition>, AgentLoopHostError> {
        ...
        let initial = select_active_set_for_mode(
            &state.catalog,
            &PromotedSet::default(),
            self.caps,
            &self.policy,

...
use ironclaw_webui::webui_v2::{
    ...
    WEBUI_V2_ROUTE_WEB_PUSH_SUBSCRIBE, WEBUI_V2_ROUTE_WEB_PUSH_UNSUBSCRIBE, webui_v2_routes,
};
...
fn expected_table() -> Vec<Expected> {
    vec![
        ...
        Expected {
            route_id: WEBUI_V2_ROUTE_WEB_PUSH_STATUS,
            method: NetworkMethod::Get,
            pattern: "/api/webchat/v2/web-push/status",
            listener_class: ListenerClass::LocalGateway,
            auth_schemes: &[IngressAuthScheme::BearerToken],
            scope_source: IngressScopeSource::AuthenticatedCaller,
            body_limit: BodyLimitPolicy::NoBody,
        ...
        Expected {
            route_id: WEBUI_V2_ROUTE_WEB_PUSH_SUBSCRIBE,
            method: NetworkMethod::Post,
            pattern: "/api/webchat/v2/web-push/subscriptions",
            listener_class: ListenerClass::LocalGateway,
            auth_schemes: &[IngressAuthScheme::BearerToken],
            scope_source: IngressScopeSource::AuthenticatedCaller,
            body_limit: body_limit_kib(8),
        ...
        Expected {
            route_id: WEBUI_V2_ROUTE_WEB_PUSH_UNSUBSCRIBE,
            method: NetworkMethod::Post,
            pattern: "/api/webchat/v2/web-push/subscriptions/remove",
            listener_class: ListenerClass::LocalGateway,
            auth_schemes: &[IngressAuthScheme::BearerToken],
            scope_source: IngressScopeSource::AuthenticatedCaller,
            body_limit: body_limit_kib(8),

...
registerPack("hi", {
  ...
  "authGate.authorizationUnavailable":
    "IronClaw {provider} प्राधिकरण शुरू नहीं कर सका। प्रदाता तक पहुँच नहीं है या वह अभी कॉन्फ़िगर नहीं हुआ है, इसलिए खोलने के लिए कुछ नहीं है। रन दोबारा चलाएँ, या एक्सटेंशन का सेटअप जाँचें।",

...
registerPack("en", {
  ...
  "tools.description.builtin.read": "Read text files and directory contents, and extract text from supported document files through scoped mounts",
  "tools.description.builtin.write": "Write content through scoped mounts",
  ...
  "tools.description.builtin.edit": "Apply exact or fuzzy search-replace edits through scoped mounts",

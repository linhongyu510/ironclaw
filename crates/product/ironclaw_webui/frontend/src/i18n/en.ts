...
registerPack("en", {
  ...
  "llm.policySaveFailed": "Could not save the model selection policy.",
  ...
  "llm.skillLearningTitle": "Skill learning",
  "llm.skillLearningDesc": "After every successful run, a background review looks for repeatable know-how and may create or refine a skill.",
  "llm.skillLearningToggleLabel": "Learn skills after successful runs",
  "llm.skillLearningModelLabel": "Learning model",
  "llm.skillLearningModelRequired": "Choose a learning model before turning learning on.",
  "llm.skillLearningNoActiveProvider": "Learning needs an active LLM provider.",
  "llm.skillLearningSaving": "Saving...",
  "llm.skillLearningSaveFailed": "Could not update skill learning.",
  "llm.skillLearningEnabledStatus": "On — learning runs after every successful run.",
  "llm.skillLearningDisabledStatus": "Off — no background review runs.",
  "llm.skillLearningInvalidNotice": "Saved learning settings are invalid — learning is not running.",
  ...
  "llm.preferenceLoadFailed": "Could not load your model preference.",
  "llm.preferenceSaveFailed": "Could not save your model preference.",
  "llm.modelRequired": "A model is required.",
  "llm.modelsFetched": "{count} models found.",
  "llm.modelsFetchFailed": "No models were returned.",
  "llm.modelsLoadFailed": "Could not load models.",
  ...
  "automations.notificationChannels.devicePush.checking": "Checking this browser's notification support…",
  "automations.notificationChannels.devicePush.unsupported": "Push notifications aren't available in this browser.",
  "automations.notificationChannels.devicePush.permissionDenied": "Notifications are blocked for this site. Allow them in your browser's site settings, then try again.",
  "automations.notificationChannels.devicePush.notEnrolled": "This browser isn't receiving notifications yet.",
  "automations.notificationChannels.devicePush.enrolled": "This browser receives notifications.",
  "automations.notificationChannels.devicePush.enroll": "Enable notifications in this browser",
  ...
  "automations.notificationChannels.devicePush.actionFailed": "Couldn't update this browser's notification enrollment. Please try again.",
  "automations.notificationChannels.devicePush.enrolledOtherAccount": "This browser is enrolled for a different account. You can enable it for this account too.",
  "automations.notificationChannels.devicePush.enableForAccount": "Enable for this account",
  "automations.notificationChannels.devicePush.statusFailed": "Couldn't load this account's enrollment status. Try reloading the page.",
  ...
  "extensions.setupPhaseLabel": "Setup state:",
  "extensions.setupPhase.uninstalled": "Not installed",
  "extensions.setupPhase.setup_needed": "Setup needed",
  "extensions.setupPhase.active": "Active",
  "extensions.setupPhase.unknown": "Unknown",
  "extensions.setupBlocker.setup": "Additional setup is required before this extension can activate.",
  "extensions.setupBlocker.auth": "Connect this extension's account to continue.",
  "extensions.setupBlocker.pairing": "Finish pairing the channel to continue.",
  "extensions.setupBlocker.approval": "Approval is required before this extension can activate.",
  "extensions.setupBlocker.policy": "A policy is preventing this extension from activating.",
  "extensions.setupBlocker.credential": "Configure the required credential to continue.",
  "extensions.setupBlocker.runtime": "This extension is not supported by the current runtime.",
  "extensions.setupBlocker.unknown": "This extension still has an unresolved setup requirement.",
  "extensions.setupFieldsAdminRequired": "An administrator must finish configuring this extension.",
...
registerPack("en", {
  ...
  "pairing.continueConnect": "Continue to connect {name}",

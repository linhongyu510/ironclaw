...
registerPack("en", {
  ...
  "chat.modelWorkspaceDefault": "Workspace default",
  "chat.modelWorkspaceDefaultWithModel": "Workspace default · {model}",
  "chat.modelSelectionDisabled": "Model selection is not available for this workspace.",
  "chat.modelUnavailable": "{model} (unavailable)",
  "chat.modelLoadFailed": "Couldn't load conversation models.",
  "chat.modelSaveFailed": "Couldn't update the conversation model.",

...
registerPack("en", {
  ...
  "ironhub.link.title": "IronHub link",
  "ironhub.link.loadFailed": "The IronHub link details could not be loaded.",
  "ironhub.link.description": "Paste the shared key IronHub generated for this agent. IronHub creates the key; this agent only accepts it.",
  "ironhub.link.agentUrl": "Register URL",
  ...
  "ironhub.link.stateStored": "Saved, restart pending",
  "ironhub.link.stateAbsent": "Not configured",

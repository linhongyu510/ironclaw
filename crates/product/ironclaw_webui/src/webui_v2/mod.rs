...
pub use descriptors::{
    ...
    WEBUI_V2_ROUTE_DELETE_THREAD, WEBUI_V2_ROUTE_EXECUTE_COMMAND,
    WEBUI_V2_ROUTE_GENERATE_SUGGESTIONS, WEBUI_V2_ROUTE_GET_ATTACHMENT,
    ...
    WEBUI_V2_ROUTE_GET_USER_MODEL_CATALOG, WEBUI_V2_ROUTE_IMPORT_EXTENSION,
    WEBUI_V2_ROUTE_INSPECTOR_PROMPT, WEBUI_V2_ROUTE_INSPECTOR_SNAPSHOT,
    WEBUI_V2_ROUTE_INSPECTOR_TOOL, WEBUI_V2_ROUTE_INSPECTOR_UPDATES,
    ...
    WEBUI_V2_ROUTE_LIST_COMMANDS, WEBUI_V2_ROUTE_LIST_EXTENSION_REGISTRY,
    ...
    WEBUI_V2_ROUTE_LOGS, WEBUI_V2_ROUTE_NOTIFICATION_SETUP_DISABLE,
    ...
    WEBUI_V2_ROUTE_STREAM_EVENTS_WS, WEBUI_V2_ROUTE_SUGGESTIONS,
...
pub use handlers::{
    ...
    admin_list_thread_scrape_threads, browse_fs_dir, cancel_run, complete_nearai_wallet_login,
    create_thread, delete_automation, delete_llm_provider, delete_thread, execute_command,
    generate_suggestions, get_attachment, get_extension_setup, get_llm_config,
    ...
    get_suggestions, get_timeline, get_user_model_catalog, install_extension, install_skill,
    ironhub_deliver_install, list_automations, list_commands, list_extension_admin_configuration,
    ...
    set_user_model_policy, setup_extension, start_codex_login, start_nearai_login, stat_fs_path,
    stream_events, stream_events_ws, test_llm_connection, trace_account_traces, trace_credits,

...
pub use handlers::{
    ...
    search_skills, session_channel_message, set_active_llm, set_auto_activate_learned,
    set_notification_channels, set_operator_config_key, set_settings_tool_permission,

...
pub use descriptors::{
    ...
    WEBUI_V2_ROUTE_GET_THREAD_ARTIFACT, WEBUI_V2_ROUTE_GET_THREAD_MODEL_PREFERENCE,
    WEBUI_V2_ROUTE_GET_TIMELINE, WEBUI_V2_ROUTE_GET_USER_MODEL_CATALOG,
    ...
    WEBUI_V2_ROUTE_SET_SKILL_AUTO_ACTIVATE, WEBUI_V2_ROUTE_SET_THREAD_MODEL_PREFERENCE,
    WEBUI_V2_ROUTE_SET_USER_MODEL_POLICY, WEBUI_V2_ROUTE_SETUP_EXTENSION,
...
pub use handlers::{
    ...
    get_run_artifact, get_session, get_skill_content, get_thread_model_preference, get_timeline,
    get_user_model_catalog, install_extension, install_skill, ironhub_deliver_install,
    ...
    set_settings_tools_auto_approve, set_skill_auto_activate, set_thread_model_preference,

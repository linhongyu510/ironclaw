...
pub use descriptors::{
    ...
    WEBUI_V2_ROUTE_SET_SKILL_LEARNING, WEBUI_V2_ROUTE_SET_USER_MODEL_POLICY,
...
pub use handlers::{
    ...
    list_outbound_delivery_targets, list_settings_tools, list_skills, list_suggestions,
    list_threads, mark_all_notifications_read, mark_notification_read, pause_automation,
    ...
    set_skill_learning, set_user_model_policy, set_user_model_preference, setup_extension,

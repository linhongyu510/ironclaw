...
pub use descriptors::{
    ...
    WEBUI_V2_ROUTE_ADMIN_UPDATE_USER, WEBUI_V2_ROUTE_ARCHIVE_NOTIFICATION,
    ...
    WEBUI_V2_ROUTE_GET_USER_MODEL_CATALOG, WEBUI_V2_ROUTE_GET_USER_MODEL_PREFERENCE,
    ...
    WEBUI_V2_ROUTE_LIST_NOTIFICATIONS, WEBUI_V2_ROUTE_LIST_OUTBOUND_DELIVERY_TARGETS,
    WEBUI_V2_ROUTE_LIST_PROJECT_FILES, WEBUI_V2_ROUTE_LIST_PROJECT_MEMBERS,
    WEBUI_V2_ROUTE_LIST_PROJECTS, WEBUI_V2_ROUTE_LIST_SETTINGS_TOOLS, WEBUI_V2_ROUTE_LIST_SKILLS,
    WEBUI_V2_ROUTE_LIST_THREADS, WEBUI_V2_ROUTE_LOGS, WEBUI_V2_ROUTE_MARK_ALL_NOTIFICATIONS_READ,
    WEBUI_V2_ROUTE_MARK_NOTIFICATION_READ, WEBUI_V2_ROUTE_NOTIFICATION_SETUP_DISABLE,
    WEBUI_V2_ROUTE_NOTIFICATION_SETUP_ENABLE, WEBUI_V2_ROUTE_NOTIFICATION_SETUP_STATUS,
    ...
    WEBUI_V2_ROUTE_OPERATOR_REPLACE_EXTENSION_CONFIGURATION, WEBUI_V2_ROUTE_OPERATOR_RUN_SETUP,
    ...
    WEBUI_V2_ROUTE_SESSION_CHANNEL_MESSAGE, WEBUI_V2_ROUTE_SET_ACTIVE_LLM,
    ...
    WEBUI_V2_ROUTE_SET_SKILL_AUTO_ACTIVATE, WEBUI_V2_ROUTE_SET_USER_MODEL_POLICY,
    WEBUI_V2_ROUTE_SET_USER_MODEL_PREFERENCE, WEBUI_V2_ROUTE_SETUP_EXTENSION,
...
pub use handlers::{
    ...
    delete_thread, execute_command, get_attachment, get_extension_setup, get_llm_config,
    get_notification_channels, get_operator_config_key, get_operator_diagnostics,
    get_operator_setup, get_operator_status, get_run_artifact, get_session, get_skill_content,
    get_timeline, get_user_model_catalog, get_user_model_preference, install_extension,
    install_skill, ironhub_deliver_install, list_automations, list_commands,
    list_extension_admin_configuration, list_extension_registry, list_extensions, list_fs_mounts,
    list_llm_models, list_notifications, list_operator_config, list_outbound_delivery_targets,
    list_settings_tools, list_skills, list_threads, mark_all_notifications_read,
    mark_notification_read, pause_automation, query_logs, query_operator_logs, read_fs_file,
    register_hosted_mcp_extension, remove_extension, remove_skill, rename_automation,
    replace_extension_admin_configuration, resolve_gate, resume_automation, retry_run,
    run_operator_service_lifecycle, run_operator_setup, search_skills, session_channel_message,
    set_active_llm, set_auto_activate_learned, set_notification_channels, set_operator_config_key,

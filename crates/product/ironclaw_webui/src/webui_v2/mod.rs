...
pub use descriptors::{
    ...
    WEBUI_V2_ROUTE_IRONHUB_DELIVER_INSTALL, WEBUI_V2_ROUTE_IRONHUB_LINK,
    WEBUI_V2_ROUTE_IRONHUB_LINK_CLEAR_KEY, WEBUI_V2_ROUTE_IRONHUB_LINK_SET_KEY,
...
pub use handlers::{
    ...
    install_extension, install_skill, ironhub_deliver_install, list_automations, list_commands,

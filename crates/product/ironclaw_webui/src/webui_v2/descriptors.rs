...
pub const WEBUI_V2_ROUTE_SET_SKILL_LEARNING: &str = "webui.v2.set_skill_learning";
...
pub const WEBUI_V2_PATTERN_SET_SKILL_LEARNING: &str = "/api/webchat/v2/llm/skill-learning";
...
pub fn is_webui_v2_operator_webui_config_route_id(route_id: &str) -> bool {
    matches!(
        ...
        WEBUI_V2_ROUTE_GET_LLM_CONFIG
            ...
            | WEBUI_V2_ROUTE_SET_SKILL_LEARNING
...
fn set_skill_learning_descriptor() -> IngressRouteDescriptor {
    descriptor(
        WEBUI_V2_ROUTE_SET_SKILL_LEARNING,
        NetworkMethod::Put,
        WEBUI_V2_PATTERN_SET_SKILL_LEARNING,
        mutation_policy(
            body_limit_kib(4),
            mutation_rate_limit(),
            AuditTraceClass::UserAction,

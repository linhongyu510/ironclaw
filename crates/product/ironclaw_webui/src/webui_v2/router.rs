...
use crate::webui_v2::descriptors::{
    ...
    WEBUI_V2_PATTERN_EXECUTE_COMMAND, WEBUI_V2_PATTERN_GENERATE_SUGGESTIONS,
    ...
    WEBUI_V2_PATTERN_NOTIFICATION_SETUP_DISABLE, WEBUI_V2_PATTERN_NOTIFICATION_SETUP_ENABLE,
    WEBUI_V2_PATTERN_NOTIFICATION_SETUP_STATUS, WEBUI_V2_PATTERN_OPERATOR_CONFIG,
    ...
    WEBUI_V2_PATTERN_STREAM_EVENTS_WS, WEBUI_V2_PATTERN_SUGGESTIONS,
...
pub fn webui_v2_router_with_options(state: WebUiV2State, options: WebUiV2RouteOptions) -> Router {
    ...
    let mut router = Router::new()
        ...
        .route(WEBUI_V2_PATTERN_SUGGESTIONS, get(handlers::get_suggestions))
        .route(

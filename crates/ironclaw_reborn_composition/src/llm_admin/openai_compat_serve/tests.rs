...
) -> ironclaw_product_contracts::llm_config::LlmProviderView {
    ironclaw_product_contracts::llm_config::LlmProviderView {
        id: id.to_string(),
...
fn model_entries_list_active_first_then_providers_deduped() {
    let snapshot = ironclaw_product_contracts::llm_config::LlmConfigSnapshot {
        providers: vec![
        ...
        active: Some(ironclaw_product_contracts::llm_config::LlmActiveSelection {
            provider_id: "openai".to_string(),

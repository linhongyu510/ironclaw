...
- Keep script-specific execution semantics here. Extension parsing belongs in `ironclaw_extension_registry`, dispatch selection in `ironclaw_capabilities`, process lifecycle in `ironclaw_processes`, and product workflow outside this crate.

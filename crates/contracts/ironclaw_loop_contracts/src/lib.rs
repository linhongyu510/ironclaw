...
pub use host::{
    ...
    LoopInlineMessageBody, LoopInlineMessagePlacement, LoopInlineMessageRole, LoopInput,
    ...
    LoopModelRequest, LoopModelResponse, LoopModelRouteSnapshot, LoopModelToolChoice,
    LoopModelUsage, LoopProcessRef, LoopProgressEvent, LoopProgressPort, LoopPromptBundle,
    LoopPromptBundleAuthority, LoopPromptBundleGrant, LoopPromptBundleRef, LoopPromptBundleRequest,
    LoopPromptDiagnosticMetadata, LoopPromptPort, LoopRecoveryClass, LoopRecoveryDisposition,
    LoopRecoveryStage, LoopRequest, LoopRequestBatch, LoopRunContext, LoopRunInfoPort,

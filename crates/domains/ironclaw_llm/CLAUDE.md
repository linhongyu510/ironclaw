...
| `anthropic_oauth.rs` | Direct Anthropic Messages API provider for API-key and Claude.ai OAuth authentication, including provider-native deferred tool loading |

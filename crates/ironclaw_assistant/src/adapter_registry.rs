...
pub use ironclaw_extension_registry::ManifestHash;
...
impl HostIngressRoute {
    ...
    /// handle newtype `ironclaw_assistant` owns. It is reused here rather
...
fn project_product_adapter_sections(
    ...
    // `ironclaw_extension_registry` validates host-api sections from its internal
    ...
    // API in `ironclaw_extension_registry` instead of caching private parser state here.

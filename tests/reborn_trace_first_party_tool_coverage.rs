...
use ironclaw_host_runtime::{
    ATTACH_WORKSPACE_FILE_TO_REPLY_CAPABILITY_ID, ECHO_CAPABILITY_ID, GLOB_CAPABILITY_ID,
    ...
    OMP_WRITE_CAPABILITY_ID, PROFILE_SET_CAPABILITY_ID, SHELL_CAPABILITY_ID,

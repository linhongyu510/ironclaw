...
//!
//! Grants the five pinned coding capability ids
...
//! pinned coding built-in package + handlers
...
use ironclaw_host_runtime::{
    ...
    CODING_READ_CAPABILITY_ID, CODING_WRITE_CAPABILITY_ID,
};
...
fn coding_tools_with_runtime_policy(
    ...
    Ok(ToolsProfile {
        // The temporary benchmark arm advertises only the five pinned coding

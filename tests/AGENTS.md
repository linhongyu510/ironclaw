...
| Context overflow compacts an oversized durable message through summarizer-input-only truncation, emits typed durable drop evidence, preserves the original transcript, and resumes once | `model_recovery.rs::context_overflow_recovers_with_model_visible_observation` |

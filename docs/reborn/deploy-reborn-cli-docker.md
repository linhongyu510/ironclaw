...
Set `IRONCLAW_REBORN_SKIP_RC1_CHANNEL_STATE_MIGRATION=false` to opt into the
verified legacy channel-state import. This setting does not affect threads,
routines, artifacts, extension installations, or other release-pair domains.

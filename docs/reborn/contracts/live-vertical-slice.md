...
**Crates:** `ironclaw_filesystem`, `ironclaw_extension_registry`, `ironclaw_resources`, `ironclaw_event_log`, `ironclaw_capabilities`, `ironclaw_host_runtime`, `ironclaw_scripts`

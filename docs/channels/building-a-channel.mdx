...
Now that the crate is ready, implement the channel guest interface exposed by `crates/ironclaw_wasm/wit/channel.wit`, and implement the guest trait methods to handle incoming messages and send responses.
...
wit_bindgen::generate!({
    ...
    path: "../../crates/ironclaw_wasm/wit/channel.wit",  // Adjust path as needed
});

...
Create a new crate outside the retired legacy source trees with this layout:
...
Now that the crate is ready, implement the channel guest interface exposed by `crates/lanes/ironclaw_wasm/wit/channel.wit`, and implement the guest trait methods to handle incoming messages and send responses.
...
wit_bindgen::generate!({
    ...
    // Relative to the guest crate, e.g. crates/extensions/packages/<name>/wasm-src.
    path: "../../../../ironclaw_wasm/wit/channel.wit",
});

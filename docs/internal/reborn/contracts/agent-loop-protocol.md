...
**Depends on:** `docs/internal/reborn/contracts/runtime-workflows.md`, `docs/internal/reborn/contracts/capability-access.md`, `docs/internal/reborn/contracts/run-state.md`
**Reference loop mechanics:** `docs/internal/reborn/contracts/lightweight-agent-loop.md`

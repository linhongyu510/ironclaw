...
**Depends on:** `docs/internal/reborn/contracts/agent-loop-protocol.md`, `docs/internal/reborn/contracts/runtime-workflows.md`, `docs/internal/reborn/contracts/capabilities.md`, `docs/internal/reborn/contracts/run-state.md`, `docs/internal/reborn/contracts/approvals.md`, `docs/internal/reborn/contracts/events.md`, `docs/internal/reborn/contracts/runtime-selection.md`, `docs/internal/reborn/contracts/runtime-profiles.md`

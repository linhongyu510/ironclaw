...
**Depends on:** `docs/internal/reborn/contracts/host-api.md`
...
See `docs/internal/reborn/contracts/approvals.md` for how approval resolution issues leases and how resume claims/consumes them.

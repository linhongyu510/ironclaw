...
**Files:**
- Modify: `crates/app/ironclaw_cli/tests/smoke.rs`
...
Add `dockerfile_reborn_ships_extension_ownership_migration` to `crates/app/ironclaw_cli/tests/smoke.rs`. It must assert that the builder stage contains all of:
...
```bash
git add Dockerfile.reborn crates/app/ironclaw_cli/tests/smoke.rs crates/ironclaw_reborn_migration/Cargo.toml crates/ironclaw_reborn_migration/src/lib.rs crates/ironclaw_reborn_migration/src/report.rs crates/ironclaw_reborn_migration/src/target.rs docs/superpowers/plans/2026-07-13-railway-extension-ownership-migration-packaging.md

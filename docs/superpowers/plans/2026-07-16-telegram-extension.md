...
- Modify: `crates/ironclaw_composition/Cargo.toml` (features block ~L74), `crates/ironclaw_reborn_cli/Cargo.toml` (~L51), `crates/ironclaw_composition/src/extension_host/available_extensions.rs`, `scripts/ci/package-feature-flags.sh` (L44/L55)

...
├── crates/app/ironclaw_cli/        # Primary CLI/WebUI entrypoint
...
- **Deploy to production:** See [Configuration](reference/configuration.md) and Dockerfile patterns in `crates/app/ironclaw_cli`
